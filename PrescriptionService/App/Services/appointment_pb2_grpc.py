...
from App.Services import appointment_pb2 as appointment__pb2
...
class AppointmentServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetAppointmentById = channel.unary_unary(
                '/appointment.AppointmentService/GetAppointmentById',
                request_serializer=appointment__pb2.AppointmentIdRequest.SerializeToString,
...
def add_AppointmentServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetAppointmentById': grpc.unary_unary_rpc_method_handler(
                    servicer.GetAppointmentById,
                    request_deserializer=appointment__pb2.AppointmentIdRequest.FromString,
...
class AppointmentService(object):
    ...
    def GetAppointmentById(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/appointment.AppointmentService/GetAppointmentById',
            appointment__pb2.AppointmentIdRequest.SerializeToString,
