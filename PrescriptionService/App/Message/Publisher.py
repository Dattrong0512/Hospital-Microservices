...
class RabbitMQPublisher:
    # def __init__(self, host=RABBITMQ_HOST, exchange='notification_exchange', routing_key='prescription'):
    def __init__(self, url=RBBITMQ_URL, exchange='notification_exchange', routing_key='prescription'):
        self.url = url
        # self.host = host
    ...
    def send_message(self, message_dict):
        try:
            ...
            channel.queue_bind(exchange=self.exchange, queue='prescription_queue', routing_key=self.routing_key)
